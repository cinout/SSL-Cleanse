...
To use our detector, you can run the following command. Take encoders on ImageNet100 as an example.

The `emb` is the dimension of the encoder output. The `attack_succ_threshold` is the
